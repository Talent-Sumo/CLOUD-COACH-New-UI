                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={12} md={6} lg={6} sx={{ margin: "auto" }}>
                                <Typography variant='h5' align='end'>
                                    Congratulations, you are awarded a business <span style={{ color: "#1976d2" }}>Extraordinary</span> level recognition for consistently completing workplace simulations.
